        ...
        try (PreparedStatement statement = connection.prepareStatement(GET_HIST_OFERTA_JOGO_QUERY)) {
            ...
            try (ResultSet result = statement.executeQuery()) {
                ...
                while (result.next()) {
                    ...
                    historico.setDataColeta( result.getDate("data_coleta").toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
        ...
        try (PreparedStatement statement = connection.prepareStatement(GET_ALL_QUESTIONS)) {
            ...
            try (ResultSet result = statement.executeQuery()) {
                ...
                while (result.next()) {
                    ...
                    pergunta.setDataPergunta(dateFormat.format(result.getDate("data_pergunta")));
                    pergunta.setDataResposta(dateFormat.format(result.getDate("data_resposta")));
